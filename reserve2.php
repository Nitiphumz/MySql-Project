...
<h1>Reserve Infomation</h1>
    <a class="btn btn-primary float-end" href="addreserve2.php" role="button">จองคิวตัดผม <i class="bi bi-plus-square"></i></a>
    ...
    <div class="container-fluid">
        <table class="table">
            ...
            <tbody>
                ...
                <td><a class="btn btn-outline-secondary" href="addreserve2.php?reserveid=
