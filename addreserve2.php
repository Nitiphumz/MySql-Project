...
<h1>Reserve Infomation : <?php echo $reserveid == '' ? 'เพิ่ม' : 'แก้ไข'; ?> การจอง </h1>
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input name="status" type="text" class="form-control" id="status" value="<?php echo empty($reserveid) ? '' : $rowitem["status"]; ?>" <?php echo empty($reserveid) ? '' : 'disabled'; ?>>
        </div>
                    <br>
        <button type="submit" class="btn btn-primary">Save</button>
        <a href="reserve2.php" class="btn btn-secondary">Cancel</a>
    </form>
</div>
